...
const Home = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	if ($$props.beers === void 0 && $$bindings.beers && beers !== void 0) $$bindings.beers(beers);

	return `${beers
	? `<ul>${each(beers, beer => `<li><a href="${"/beer/" + escape(beer._id)}">${escape(beer.name)}</a>
            </li>`)}</ul>`
	: ``}`;
});
...
const Beer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	if ($$props.beer === void 0 && $$bindings.beer && beer !== void 0) $$bindings.beer(beer);

	return `${beer
	? `<ul>${each(beer, beer => `<li><a href="${"/beer/" + escape(beer._id)}">${escape(beer.name)}</a>
            </li>`)}</ul>`
	: ``}`;
});
...
const App = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  <div>${validate_component(Route, "Route").$$render($$result, { path: "about", component: About }, {}, {})}
    ${validate_component(Route, "Route").$$render($$result, { path: "beer/*", component: Beer }, {}, {})}
